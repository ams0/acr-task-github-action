...
export SERVICE_PRINCIPAL=$INPUT_SERVICE_PRINCIPAL
export SERVICE_PRINCIPAL_PASSWORD=$INPUT_SERVICE_PRINCIPAL_PASSWORD
export TENANT=$INPUT_TENANT
...
az login --service-principal -u ${SERVICE_PRINCIPAL} -p ${SERVICE_PRINCIPAL_PASSWORD} --tenant ${INPUT_TENANT}

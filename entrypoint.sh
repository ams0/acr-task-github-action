...
az acr build -r ${INPUT_REGISTRY} -f ${INPUT_DOCKERFILE} -t ${INPUT_REPOSITORY}/${INPUT_IMAGE}:${INPUT_TAG} https://github.com/${GITHUB_REPOSITORY}#${INPUT_BRANCH}:${INPUT_FOLDER}
